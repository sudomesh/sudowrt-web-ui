...
},{"./libs/ubus.js":12,"es6-promise":2,"lodash":4,"moment":5,"riot":6}],12:[function(require,module,exports){
(function (global){
$ = require('jquery');
require('jsonrpc');
...
},{"jquery":3,"jsonrpc":10,"moment":5}],13:[function(require,module,exports){
var $ = require('jquery');
var _ = require('lodash');
...
},{"./dashboard-store":11,"./section-configs.js":14,"./tags/header.tag":15,"./tags/input-settings.tag":16,"./tags/login-modal.tag":17,"./tags/password-change.tag":18,"jquery":3,"lodash":4,"riot":6,"riotcontrol":7,"speakingurl":8}],14:[function(require,module,exports){
module.exports = {
  wireless: {
    title: 'Wireless',
    uciConfigs: [
...
},{"riot":6,"riotcontrol":7}],16:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('input-settings', '<div each="{ sections }"> <h2>{ title }</h2> <div each="{ uciInputs }"> <label for="{ slug }-input">{ labelTitle }</label> <form onsubmit="{ parent.parent.save }" class="inputs-container"> <input id="{ slug }-input" type="{ format }" value="{ this.value }" onchange="{ parent.parent.inputChanged }"><span if="{ units }">({ units })</span> <button type="submit">save</button> </form> </div> </div>', function(opts) {
var RiotControl = require('riotcontrol');
var _ = require('lodash');
var self = this;
...
},{"lodash":4,"riot":6,"riotcontrol":7}],17:[function(require,module,exports){
var riot = require('riot');
...
},{"riot":6,"riotcontrol":7}],18:[function(require,module,exports){
var riot = require('riot');
