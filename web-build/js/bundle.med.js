...
},{"./lib/speakingurl":8}],8:[function(require,module,exports){
...
module.exports = function TodoStore() {
  ...
  this.changePassword = function(credentials, callback) {
    ubus.call('password.set', {username: self.username, password: credentials.new_password}, function(err, result) {
      if (err) {
        console.log(err);
        RiotControl.trigger('password_error', err);
      } else {
        RiotControl.trigger('password_success', result);
      }
    });
  };
      ...
      ubus.call('uci.configs', {}, function(err, result) {
        if (typeof result === 'object' &&
          ...
          Promise.all(configPromises).then(function(resultsArray) {
            ...
            self.trigger('settings_changed', self.uciConfigs);
...
},{"./libs/ubus.js":11,"es6-promise":2,"lodash":4,"riot":5}],11:[function(require,module,exports){
(function (global){
$ = require('jquery');
require('jsonrpc');
...
},{"jquery":3,"jsonrpc":9}],12:[function(require,module,exports){
var $ = require('jquery');
var _ = require('lodash');
...
},{"./dashboard-store":10,"./section-configs.js":13,"./tags/header.tag":14,"./tags/input-settings.tag":15,"./tags/login-modal.tag":16,"./tags/password-change.tag":17,"jquery":3,"lodash":4,"riot":5,"riotcontrol":6,"speakingurl":7}],13:[function(require,module,exports){
module.exports = {};

},{}],14:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('header', '<h1>sudowrt settings</h1> <span if="{ loggedIn }"> Logged in as: { username } <div title="Logout" class="clickable" onclick="{ logout }"> Logout <span class="glyphicon glyphicon-log-out" alt="Logout"></span> </div> </span> <span if="{ !loggedIn }"> <div title="Login" class="clickable" onclick="{ login }"> Login <span class="glyphicon glyphicon-log-in" alt="Login"></span> </div> </span>', function(opts) {
...
},{"riot":5,"riotcontrol":6}],15:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('input-settings', '<h1>{ section_name }</h1> <div each="{ items }"> <label for="{ slug }">{ name }</label> <input type="{ type }" id="slug" value="{ value }"><span if="{ units }">({ units })</span> <button onclick="{ parent.save }">save</button> </div>', function(opts) {
var RiotControl = require('riotcontrol');
var self = this;
...
},{"riot":5,"riotcontrol":6}],16:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('login-modal', ' <div class="md-modal md-effect-1 {md-show: dialogShowing}"> <div class="md-content"> <h3>Login</h3> <div> <form onsubmit="{ login }"> <input name="username" type="text"> <input name="password" type="password"> <button>Submit</button> </form> <button onclick="{ close }">close</button> </div> </div> </div> <div class="md-overlay" onclick="{ close }"></div>', function(opts) {
...
},{"riot":5,"riotcontrol":6}],17:[function(require,module,exports){
var riot = require('riot');
module.exports = riot.tag('password-change', '<div if="{ loggedIn }"> <div class="subheading"> <span class="clickable" onclick="{ toggle }">Change admin password</span> </div> <form if="{ showForm }" onsubmit="{ save }"> <label for="old_password">old password:</label><input type="password" id="old_password" name="old_password"> <label for="new_password">new password:</label><input type="password" id="new_password" name="new_password"> <label for="new_password2">new password (again):</label><input type="password" id="new_password2" name="new_password2"> <button onclick="{ parent.save }">save</button> <div if="{ showErrorMsg }" class="error-msg">{ errorMessage }</div> </form> </div>', function(opts) {
var RiotControl = require('riotcontrol');
var self = this;
...
this.save = function (e) {
  if (self.old_password && self.new_password && self.new_password2) {
