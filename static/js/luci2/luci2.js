...
// basePath sets the path from which to load luci2 javascript files
function LuCI2(basePath)
{
	var L = this;
  L.basePath = basePath || '';
	...
	{
    var nameNoParent = name.split('.').slice(1).join('.');
		var path = (L.basePath || '') + '/' + nameNoParent.replace(/\./g, '/') + '.js';
